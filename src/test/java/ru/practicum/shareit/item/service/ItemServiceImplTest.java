...
class ItemServiceImplTest {
    ...
    void testGet() {
        ...
        when(itemMapper.toItemDto(Mockito.<Item>any())).thenReturn(buildResult);
        when(bookingRepository.findAllByItem_idAndStatusAndItem_owner_id(Mockito.<Long>any(), Mockito.<BookingStatus>any(),
    ...
    @Test
    void testGetAll() {
        when(itemRepository.findAllByOwnerId(Mockito.<Long>any(), Mockito.<Pageable>any())).thenReturn(new ArrayList<>());
        when(bookingRepository.findAllByItem_idInAndStatusAndItem_owner_id(Mockito.<List<Long>>any(),
                Mockito.<BookingStatus>any(), Mockito.<Long>any())).thenReturn(new ArrayList<>());

        List<ItemDto> actualAll = itemServiceImpl.getAll(1L, null);

        verify(bookingRepository).findAllByItem_idInAndStatusAndItem_owner_id(Mockito.<List<Long>>any(),
                eq(BookingStatus.APPROVED), Mockito.<Long>any());
        verify(itemRepository).findAllByOwnerId(Mockito.<Long>any(), Mockito.<Pageable>any());
    ...
    void testGetAll2() {
        when(itemRepository.findAllByOwnerId(Mockito.<Long>any(), Mockito.<Pageable>any())).thenReturn(new ArrayList<>());
        when(bookingRepository.findAllByItem_idInAndStatusAndItem_owner_id(Mockito.<List<Long>>any(),
                Mockito.<BookingStatus>any(), Mockito.<Long>any())).thenThrow(new NotFoundException("An error occurred"));
    ...
    void testGetAll3() {
        ...
        itemList.add(item);
        when(itemRepository.findAllByOwnerId(Mockito.<Long>any(), Mockito.<Pageable>any())).thenReturn(itemList);
        ItemDto.ItemDtoBuilder availableResult = ItemDto.builder().available(true);
        ItemDto.ItemDtoBuilder idResult = availableResult.comments(new ArrayList<>())
                .description("The characteristics of someone or something")
                .id(1L);
    ...
    @Test
    void testSearch() {
        when(itemRepository.search(Mockito.<String>any(), Mockito.<Pageable>any())).thenReturn(new ArrayList<>());

        List<ItemDto> actualSearchResult = itemServiceImpl.search("Text", null);

        verify(itemRepository).search(eq("Text"), Mockito.<Pageable>any());
    ...
    void testCreateComment() {
        ...
        user.setName("Name");
        when(userService.validationFindUserById(Mockito.<Long>any())).thenReturn(user);
        when(bookingRepository.findAllByEndDateBeforeAndBooker_idAndItem_idAndStatus(Mockito.<LocalDateTime>any(),
                Mockito.<Long>any(), Mockito.<Long>any(), Mockito.<BookingStatus>any())).thenReturn(new ArrayList<>());
    ...
    void testCreateComment2() {
        ...
        when(userService.validationFindUserById(Mockito.<Long>any())).thenReturn(user);
        when(bookingRepository.findAllByEndDateBeforeAndBooker_idAndItem_idAndStatus(Mockito.<LocalDateTime>any(),
                Mockito.<Long>any(), Mockito.<Long>any(), Mockito.<BookingStatus>any()))
                .thenThrow(new NotFoundException("An error occurred"));
    ...
    void testCreateComment4() {
        ...
        when(bookingRepository.findAllByEndDateBeforeAndBooker_idAndItem_idAndStatus(Mockito.<LocalDateTime>any(),
                Mockito.<Long>any(), Mockito.<Long>any(), Mockito.<BookingStatus>any())).thenReturn(bookingList);
        ...
        when(commentMapper.toComment(Mockito.<Long>any(), Mockito.<Long>any(), Mockito.<CommentCreateDto>any()))
                .thenReturn(comment);
        ...
        verify(bookingRepository).findAllByEndDateBeforeAndBooker_idAndItem_idAndStatus(Mockito.<LocalDateTime>any(),
                Mockito.<Long>any(), Mockito.<Long>any(), eq(BookingStatus.APPROVED));
        verify(commentMapper).toComment(Mockito.<Long>any(), Mockito.<Long>any(), Mockito.<CommentCreateDto>any());
